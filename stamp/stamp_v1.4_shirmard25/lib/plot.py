...
def plot(
    ...
    cax_grid = fig.add_axes([0.1, 0.18, 0.35, 0.02])
    cax_bg = fig.add_axes([0.55, 0.18, 0.35, 0.02])
    ...
    # Draw legend
    ax.legend(custom_handles, custom_labels, fontsize=FONT_SIZE, loc="upper left", bbox_to_anchor=(0, 1.25),
