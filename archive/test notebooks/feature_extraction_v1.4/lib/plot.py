...
#         ax.add_geometries(geom, crs=ccrs.PlateCarree(), edgecolor='orangered', facecolor='none', zorder=5)
#     for geom in gplot.get_trenches(central_meridian=60).geometry:
#         ax.add_geometries(geom, crs=ccrs.PlateCarree(), edgecolor='dimgray', facecolor='none', zorder=6)
