...
def generate_feat_map(gplot, subduction_data, projection, time, feature, output_dir):
    ...
    #gplot.plot_misc_transforms(ax, color="orangered", zorder=5)
    ...
    gplot.plot_trenches(ax, color="black", alpha=0.6, zorder=6)
    ...
    gl.top_labels = Falseplt.savefig(filename, dpi=200, bbox_inches="tight")
